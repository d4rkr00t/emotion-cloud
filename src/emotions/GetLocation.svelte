...
<svg
  ...
  <g>
    <g>
      <g>
        <circle cx="150.437" cy="110.572" r="24.149" fill="white" />
        <path
          fill="white"
          ...
          M149.685,68.678c0.106,0,0.21-0.005,0.314-0.01c0.104,0.005,0.207,0.01,0.314,0.01
          ...
          C103.851,89.966,124.413,69.078,149.685,68.678z
          M150.65,232.25c-27.663,0-55.669-7.936-55.669-23.098
